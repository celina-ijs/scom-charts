import { Module, ControlElement, RequireJS, LibPath, customElements, Container, application } from '@ijstech/components';
...
export class Charts<T> extends Module {
    ...
    drawChart() {
        ...
        RequireJS.require([`${path}/lib/echarts/echarts.min.js`], (echart: any) => {
            this._echart = echart;
            this._drawChart();
        });
    }
